...
import { SubstrateWallet } from '@subwallet/wallet-connect/types';
...
function WalletInfo (): React.ReactElement {
  ...
  return <div className={'boxed-container'}>
    <div className={'wallet-info-page'}>
      <div className='wallet-info-page__text'>Version: {(walletContext?.wallet as SubstrateWallet)?.extension?.version}</div>
